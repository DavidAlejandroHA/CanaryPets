...
public class ProductsSeeder implements CommandLineRunner {
    ...
    private void seedPerros() {
        ...
        createProduct("Advance Correa resistente", "Correa duradera", new BigDecimal("15.99"), 25, false, "120x2 cm", "Advance", "productos/perros/correa.jpg", accesoriosPerros, "Advance", "Correas", null);
        ...
        createProduct("Advance Arnés cómodo", "Ajuste ergonómico", new BigDecimal("18.99"), 15, false, "50x5 cm", "Advance", "productos/perros/arnes.jpg", accesoriosPerros, "Advance", "Arneses", null);
        createProduct("Royal Canin Pelota resistente", "Juguete duradero", new BigDecimal("7.99"), 1, true, "8x8 cm", "Royal Canin", "productos/perros/pelota.jpg", juguetesPerros, "Royal Canin", "Pelotas", null);
        ...
        createProduct("Trixie Arnés ajustable", "Arnés cómodo y resistente", new BigDecimal("14.99"), 25, false, "20x10 cm", "Trixie", "productos/perros/arnes-ajustable.jpg", accesoriosPerros, "Trixie", "Arneses", null);
        createProduct("Bayer Champú antiparasitario", "Protección contra pulgas", new BigDecimal("11.99"), 18, true, "10x5 cm", "Bayer", "productos/perros/champu-antiparasitario.jpg", higienePerros, "Bayer", "Champu", null);
        ...
        createProduct("Trixie Champú piel sensible", "Limpieza suave", new BigDecimal("8.99"), 30, false, "10x5 cm", "Trixie", "productos/perros/champu-sensible.jpg", higienePerros, "Trixie", "Champu", null);
        createProduct("Beaphar Toallitas húmedas perro", "Higiene rápida", new BigDecimal("6.49"), 40, false, "10x5 cm", "Beaphar", "productos/perros/toallitas.jpg", higienePerros, "Beaphar", "Higiene", null);
        ...
        createProduct("Trixie Cepillo deslanador", "Elimina pelo muerto", new BigDecimal("12.99"), 18, true, "20x5 cm", "Trixie", "productos/perros/cepillo.jpg", higienePerros, "Trixie", "Cepillado", null);
        createProduct("Advance Champú antipulgas", "Protección externa", new BigDecimal("10.99"), 20, false, "10x5 cm", "Advance", "productos/perros/champu-antipulgas.jpg", higienePerros, "Advance", "Champu", null);
    }
    ...
    private void seedGatos() {
        ...
        createProduct("Royal Canin Ratón juguete", "Juguete clásico", new BigDecimal("4.99"), 1, true, "10x5 cm", "Royal Canin", "productos/gatos/raton.jpg", juguetesGatos, "Royal Canin", "Mordedores", null);
        ...
        createProduct("Purina Arena higiénica", "Arena absorbente", new BigDecimal("13.99"), 45, false, "30x20x10 cm", "Purina", "productos/gatos/arena.jpg", accesoriosGatos, "Purina", "Higiene", null);
...
// 🔹 ACCESORIOS
        ...
        createProduct("Trixie Bebedero automático", "Bebedero práctico", new BigDecimal("7.99"), 35, false, "10x5 cm", "Trixie", "productos/roedores/bebedero.jpg", accesoriosRoedores, "Trixie", "Bebederos", null);
        createProduct("Ferplast Comedero plástico", "Comedero resistente", new BigDecimal("5.99"), 45, false, "10x5 cm", "Ferplast", "productos/roedores/comedero.jpg", accesoriosRoedores, "Ferplast", "Comederos", null);
...
// 🔹 HIGIENE
        createProduct("Vitakraft Lecho absorbente", "Sustrato higiénico", new BigDecimal("7.99"), 50, false, "30x20x10 cm", "Vitakraft", "productos/roedores/lecho.jpg", higieneRoedores, "Vitakraft", "Lecho", null);
        ...
        createProduct("Bunny Higiene premium", "Alta absorción", new BigDecimal("9.99"), 35, false, "30x20x10 cm", "Bunny", "productos/roedores/higiene.jpg", higieneRoedores, "Bunny", "Lecho", null);
        createProduct("Ferplast Lecho ecológico", "Material reciclado", new BigDecimal("8.49"), 1, true, "30x20x10 cm", "Ferplast", "productos/roedores/lecho-eco.jpg", higieneRoedores, "Ferplast", "Lecho", null);
...
//        createProduct("Ferplast Juguete colgante", "Entretenimiento", new BigDecimal("6.99"), 1, true, "15x5 cm", "Ferplast", "productos/roedores/colgante.jpg", juguetesRoedores, "Ferplast", "Interactivos", null);
        ...
        createProduct("Trixie Bebedero cristal", "Bebedero resistente", new BigDecimal("8.49"), 35, false, "10x5 cm", "Trixie", "productos/roedores/bebedero-cristal.jpg", accesoriosRoedores, "Trixie", "Bebederos", null);
        createProduct("Vitakraft Lecho vegetal", "Sustrato ecológico", new BigDecimal("7.49"), 40, true, "30x20x10 cm", "Vitakraft", "productos/roedores/lecho-vegetal.jpg", higieneRoedores, "Vitakraft", "Lecho", null);
        ...
        createProduct("Ferplast Comedero cerámica", "Base antideslizante", new BigDecimal("6.99"), 30, false, "10x5 cm", "Ferplast", "productos/roedores/comedero-ceramica.jpg", accesoriosRoedores, "Ferplast", "Comederos", null);
        createProduct("Trixie Sustrato papel reciclado", "Alta absorción", new BigDecimal("8.49"), 40, true, "30x20x10 cm", "Trixie", "productos/roedores/sustrato-papel.jpg", higieneRoedores, "Trixie", "Lecho", null);
    }
    ...
    private void seedPeces() {
        ...
        createProduct("Sera Aireador acuario", "Oxigenación", new BigDecimal("17.99"), 1, true, "10x10 cm", "Sera", "productos/peces/aireador.jpg", accesoriosPeces, "Sera", "Accesorios", null);
...
// 🔹 ACCESORIOS
        ...
        createProduct("Trixie Bebedero aves", "Bebedero práctico", new BigDecimal("5.99"), 45, false, "10x5 cm", "Trixie", "productos/pajaros/bebedero.jpg", accesoriosPajaros, "Trixie", "Bebederos", null);
        createProduct("Ferplast Comedero aves", "Comedero resistente", new BigDecimal("4.99"), 50, false, "10x5 cm", "Ferplast", "productos/pajaros/comedero.jpg", accesoriosPajaros, "Ferplast", "Comederos", null);
...
// 🔹 HIGIENE
        ...
        createProduct("Ferplast Lecho aves", "Material absorbente", new BigDecimal("7.99"), 35, false, "30x20x10 cm", "Ferplast", "productos/pajaros/lecho.jpg", higienePajaros, "Ferplast", "Lecho", null);
        ...
        createProduct("Trixie Comedero exterior aves", "Fácil instalación", new BigDecimal("7.99"), 40, false, "15x10 cm", "Trixie", "productos/pajaros/comedero-exterior.jpg", accesoriosPajaros, "Trixie", "Comederos", null);
        ...
        createProduct("Ferplast Bebedero exterior", "Fácil instalación", new BigDecimal("6.99"), 35, false, "10x5 cm", "Ferplast", "productos/pajaros/bebedero-exterior.jpg", accesoriosPajaros, "Ferplast", "Bebederos", null);
