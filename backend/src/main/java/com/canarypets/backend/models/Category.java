...
public class Category {
    ...
    @Column(name = "name", length = 50, unique = false, nullable = false) // Importante poner unique a false
    private String name;  // Si no no puede haber distintos registros de otras categorías con el mismo nombre

    @Column(unique = false, nullable = false) // Importante poner unique a false
    private String slug;
